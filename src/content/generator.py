...
_WHY_MATTERS: dict[str, str] = {
    "LLMs":             "advances our understanding of large language models, which are reshaping how we build AI systems and interact with knowledge",
    "Transformers":     "extends Transformer capabilities — the architecture underpinning virtually every modern NLP and vision model",
    "Diffusion Models": "pushes the frontier of generative AI, enabling higher-quality and more controllable content creation",
    "RL":               "contributes to reinforcement learning — a key paradigm for training agents that make sequential decisions",
    "GNN":              "broadens the applicability of graph neural networks for structured data and relational reasoning",
    "RAG":              "improves how language models ground their responses in verified, up-to-date knowledge",
    ...
    "Multimodal":       "bridges vision and language, enabling richer AI applications that reason across modalities",
    "Federated Learning": "enables privacy-preserving machine learning across distributed data sources without sharing raw data",
    "Model Compression": "makes powerful models practical on resource-constrained devices and reduces deployment costs",
    "AI Safety & Alignment": "advances the critical goal of making AI systems safer, more reliable, and aligned with human values",
    "AI Agents":        "moves AI from passive text generators to active problem-solvers that use tools and reason over time",
    "_default":         "represents a meaningful contribution to its field and opens new research directions",
}

_HOOK_PATTERNS: dict[str, str] = {
    "LLMs":             "What if your AI assistant could {title_lower}? New research shows it's closer than you think.",
    "Diffusion Models": "The images AI can generate just got dramatically better — here's why.",
    "RL":               "Teaching machines to make better decisions — one paper at a time.",
